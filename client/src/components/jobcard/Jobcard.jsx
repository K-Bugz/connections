...
export default function JobCard({ job }) {
    ...
    return (
        <React.Fragment>
            <div className="mb-4 ">
                <div className="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-700 m-8 ">
                    <div className="flex items-center justify-between mb-10">
                        <div className="flex items-center">
                            <span className="rounded-xl p-2 bg-gradient-to-r from-blue-400 to-blue-800 text-white transition ease-in duration-200  text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 ">
                                Job Listing
                                <svg
                                    width="25"
                                    height="25"
