...
export default function Main() {
  return (
    <div className="bg-zinc-900 sm:px-6 lg:py-16 lg:px-8 z-20">
      ...
      <div class="text-center w-full mx-auto py-0 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        <h2 class="text-3xl font-extrabold text-blue-400 dark:text-white sm:text-4xl">
          <span class="block">
