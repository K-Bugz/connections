...
export default function ProfileCard() {
    return (
        <React.Fragment>
            <div className='bg-white-200 dark:bg-white flex flex-wrap items-center justify-center m-8'>
                <div className='container bg-white shadow-lg transform duration-200 easy-in-out'>
                    ...
                    <div className=' '>
                        ...
                        <div className='flex  bg-gray-50 '>
                            ...
                            <div className='text-center w-1/2 p-4 hover:bg-gray-100 cursor-pointer hover:text-blue-400'>
