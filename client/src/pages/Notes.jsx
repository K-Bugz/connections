        ...
        <div className="mb-4 mx-0 sm:ml-4 xl:mr-4">
          <div className="shadow-lg bg-white dark:bg-gray-700 w-full">
            ...
            <div className="flex items-center text-gray-600 dark:text-gray-200 justify-between py-3 border-b-2 border-gray-100 dark:border-gray-800">
              <form onSubmit={handleSubmit} className="flex items-center justify-start text-sm">
                <input
                  type="text"
                  value={todoItem}
                ...
                />
                <button type="submit" className="px-2 py-1 flex w-36 mt-4 items-center text-xs rounded-md font-bold text-blue-500 bg-blue-100">
                Add
                </button>
              </form>
            </div>
            ...
            <div className="mb-4">
              ...
              {todos.map((todoItem) => {
                ...
                return (
                  <div key={id} className="flex items-center ml-2 text-gray-600 dark:text-gray-200 justify-between py-3 border-b-2 border-gray-100 dark:border-gray-800">
